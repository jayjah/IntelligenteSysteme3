...
/**
 * This class holds the absolute chances and the calculated relative chances
 * to the absolute chances.
...
public class MarkovChances {
	...
	/**
	 * Constructor
	 * Calculates the absolute and relative chances of the given fishes
	 * @param fr List with all fishes
	 * @param k actual chosen k value
	 */
